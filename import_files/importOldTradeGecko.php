...
// get date
    ...
    $set_product->setManufacturer(ManufacturerControl($data->manufacturer));
    // manufacturer id
...
*/
    ...
    $set_product->setCountryOfManufacture($data->country_of_manufacture);
    // country of manufacture (2-letter country code)
    $set_product->setPrice($data->price);
    ...
    $set_product->setMetaKeyword($data->meta_title);
