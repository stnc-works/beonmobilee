...
$url = 'beon_mobile.json'; // path to your JSON file
...
// get date
   ...
   // $set_product->setName($data->name);
    $set_product->setName($data->name.' '.$data->length.' '.$data->color);
    // add Name of Product
    ...
    $set_product->setMfi($data->mfi);//>-----
    $set_product->setLength(LenghtControl($data->length));//>-----
    $set_product->setFrom(FromControl($data->from));//>-----
    $set_product->setTo(ToControl($data->to));//>-----
